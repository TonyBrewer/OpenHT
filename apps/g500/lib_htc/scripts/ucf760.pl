...
[ "${b}OUT__1__6737__/m_htPriv/${m}1",			1,	-1,	1],
[ "${b}OUT__1__6737__/m_htPriv/${m}2",			1,	-1,	1],
[ "${b}OUT__1__6737__/m_htPriv/${m}3",			1,	-1,	1],
[ "${b}OUT__1__6737__/m_htPriv/${m}4",			1,	-1,	1],
[ "${b}OUT__1__6737__/m_htPriv/${m}5",			1,	-1,	1],
[ "${b}OUT__1__6737__/m_htPriv/${m}6",			1,	-1,	1],
[ "${b}OUT__1__6737__/m_htPriv/${m}7",			1,	-1,	1],
[ "${b}OUT__1__6737__/m_htPriv/${m}8",			1,	-1,	1],
);
