...
class CHttOperand : public CHtfeOperand
{
public:
	CHttOperand() : CHtfeOperand() {
        ...
        m_bIsFuncGenerated = false;
	}

	CHttOperand * GetLinkedOp() { return (CHttOperand *)CHtfeOperand::GetLinkedOp(); }

	CHttOperand * GetOperand1() { return (CHttOperand *)CHtfeOperand::GetOperand1(); }
	CHttOperand * GetOperand2() { return (CHttOperand *)CHtfeOperand::GetOperand2(); }
	CHttOperand * GetOperand3() { return (CHttOperand *)CHtfeOperand::GetOperand3(); }

	CHttIdent * GetMember() { return (CHttIdent *)CHtfeOperand::GetMember(); }
	CHttIdent *GetCastType() { return (CHttIdent *)CHtfeOperand::GetCastType(); }
	CHttIdent *GetMemberType() { return (CHttIdent *)CHtfeOperand::GetMemberType(); }

	size_t GetParamCnt() { return GetParamList().size(); }
	CHttOperand * GetParam(int i) { return (CHttOperand *)(GetParamList()[i]); }

	size_t GetIndexCnt() { return GetIndexList().size(); }
	CHttOperand * GetIndex(int i) { return (CHttOperand *)(GetIndexList()[i]); }
    ...
    void SetIsExprTempVarWidth(bool bIsSubExprTempVarWidth) {
