...
void CPersGv6::PersGv6()
{
	if (PR_htValid) {
		...
		case GV6_ENTRY:
		{
			...
			// D_2x2x2x
			GW_gv_D_2x2x2x_1F_m0.write_addr(PR_htId, 0u);
			GW_gv_D_2x2x2x_1F_m0.m_x = P_x;

			GW_gv_D_2x2x2x_1F_m1.write_addr(PR_htId, 0u);
			GW_gv_D_2x2x2x_1F_m1.m_x = P_x;

			GW_gv_D_2x2x2x_2F_m0.write_addr(PR_htId);
			GW_gv_D_2x2x2x_2F_m0.m_x[0] = P_x;

			GW_gv_D_2x2x2x_2F_m1.write_addr(PR_htId);
			GW_gv_D_2x2x2x_2F_m1.m_x[0] = P_x;

			GW_gv_D_2x2x2x_1F_AI_m0.write_addr(PR_htId, 0u);
			GW_gv_D_2x2x2x_1F_AI_m0.m_x = P_x;

			GW_gv_D_2x2x2x_1F_AI_m1.write_addr(PR_htId, 0u);
			GW_gv_D_2x2x2x_1F_AI_m1.m_x = P_x;

			GW_gv_D_2x2x2x_2F_AI_m0.write_addr(PR_htId);
			GW_gv_D_2x2x2x_2F_AI_m0.m_x[0] = P_x;

			GW_gv_D_2x2x2x_2F_AI_m1.write_addr(PR_htId);
			GW_gv_D_2x2x2x_2F_AI_m1.m_x[0] = P_x;

			GW_gv_D_2x2x2x_1F_AA_m0.write_addr(PR_htId, 0u);
			GW_gv_D_2x2x2x_1F_AA_m0.m_x = P_x;

			GW_gv_D_2x2x2x_1F_AA_m1.write_addr(PR_htId, 0u);
			GW_gv_D_2x2x2x_1F_AA_m1.m_x = P_x;

			GW_gv_D_2x2x2x_4F_AA_m0.write_addr(PR_htId);
			GW_gv_D_2x2x2x_4F_AA_m0.m_x[0] = P_x;

			GW_gv_D_2x2x2x_4F_AA_m1.write_addr(PR_htId);
			GW_gv_D_2x2x2x_4F_AA_m1.m_x[0] = P_x;
		...
		case GV6_LOOP:
		{
			...
			if (GR_gv_D_2x2x2x_2F_m0.m_x[0] != PR_x) HtAssert(0, 0);
			if (GR_gv_D_2x2x2x_2F_m1.m_x[0] != PR_x) HtAssert(0, 0);
			if (GR_gv_D_2x2x2x_1F_AI_m0.m_x != PR_x) HtAssert(0, 0);
			if (GR_gv_D_2x2x2x_1F_AI_m1.m_x != PR_x) HtAssert(0, 0);
			if (GR_gv_D_2x2x2x_2F_AI_m0.m_x[0] != PR_x) HtAssert(0, 0);
			if (GR_gv_D_2x2x2x_2F_AI_m1.m_x[0] != PR_x) HtAssert(0, 0);
			if (GR_gv_D_2x2x2x_1F_AA_m0.m_x != PR_x) HtAssert(0, 0);
			if (GR_gv_D_2x2x2x_1F_AA_m1.m_x != PR_x) HtAssert(0, 0);
			if (GR_gv_D_2x2x2x_4F_AA_m0.m_x[0] != PR_x) HtAssert(0, 0);
			if (GR_gv_D_2x2x2x_4F_AA_m1.m_x[0] != PR_x) HtAssert(0, 0);
			...
			GW_gv_D_2x2x2x_2F_AI_m0.write_addr(PR_htId);
			GW_gv_D_2x2x2x_2F_AI_m0.m_x[0].AtomicInc();

			GW_gv_D_2x2x2x_2F_AI_m1.write_addr(PR_htId);
			GW_gv_D_2x2x2x_2F_AI_m1.m_x[0].AtomicInc();
			...
			GW_gv_D_2x2x2x_4F_AA_m0.write_addr(PR_htId);
			GW_gv_D_2x2x2x_4F_AA_m0.m_x[0].AtomicAdd(1u);
