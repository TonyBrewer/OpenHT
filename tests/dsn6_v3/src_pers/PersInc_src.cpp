	...
	if (PR_htValid) {
		...
		case INC_READ:
		{
			...
			if (P_loopCnt == P_elemCnt) {
				...
				switch (rdDstId) {
				case 0: ReadMem_arrayMem1Fld1(memRdAddr); break;
				case 1: ReadMem_arrayMem1Fld2(memRdAddr, 0); break;
				case 2: ReadMem_arrayMem2Fld1(memRdAddr, 0, 1); break;
				case 3: ReadMem_arrayMem2Fld2(memRdAddr, 1, 1); break;
				}
		...
		case INC_WRITE:
		{
			...
			sc_uint<2> rdDstId = P_reqCnt;
			switch (rdDstId) {
			case 0: memWrData = GR_arrayMem[0].fld[0] + 1; break;
			case 1: memWrData = GR_arrayMem[0].fld[1] + 1; break;
			case 2: memWrData = GR_arrayMem[1].fld[0] + 1; break;
			case 3: memWrData = GR_arrayMem[1].fld[1] + 1; break;
			}
